the program main class run EnginePoems.java from package com.kane.better.end. there is one variable called numberLines in the method main where you can change its to observe different outs of poems
